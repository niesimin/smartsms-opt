<template>
  <div class="tags-nav">
    <div class="close-con">
      <Dropdown transfer @on-click="handleTagsOption" style="margin-top:6px;">
        <Button size="small" type="text">
          <Icon :size="18" type="md-close-circle" />
        </Button>
    ...
    <div class="btn-con left-btn" v-show="showBtn">
      <Button type="text" @click="handleScroll(240)">
        <Icon :size="18" type="ios-arrow-back" />
      </Button>
    </div>
    <div class="btn-con right-btn" v-show="showBtn">
      <Button type="text" @click="handleScroll(-240)">
